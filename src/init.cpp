...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/gamecoin-project/gamecoin>";
    const std::string URL_WEBSITE = "<https://gamecoin.org>";
