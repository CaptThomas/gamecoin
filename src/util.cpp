...
const char * const BITCOIN_CONF_FILENAME = "gamecoin.conf";
const char * const BITCOIN_PID_FILENAME = "gamecoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Gamecoin";
#else
    // Unix
