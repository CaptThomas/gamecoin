...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s gamecoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gamecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gamecoin transaction") + "\n" +
              "  gamecoin-tx [options] -create [commands]   " + _("Create hex-encoded gamecoin transaction") + "\n" +
              "\n";
