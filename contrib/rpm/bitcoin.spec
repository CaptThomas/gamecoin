...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 62005
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 19332
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 162005
...
if [ $1 -eq 0 ]; then
	...
	%{_sbindir}/semanage port -d -p tcp 62005
	%{_sbindir}/semanage port -d -p tcp 19332
	%{_sbindir}/semanage port -d -p tcp 162005
	for selinuxvariant in %{selinux_variants}; do
